...
/*		album_info.put("Let It Be", "è l'undicesimo e ultimo album nella discografia inglese del gruppo musicale" );
	...
	public String getInfo(@PathVariable String artista) {
	...
	public String getInfo(@PathVariable String artista, @PathVariable String album) {
